...
func (w WorkerManager) Start(workerId string, topicName string, handler client.JobHandler) bool {
...
type IWorkerManager interface {
	...
	Start(workerId string, topicName string, handler client.JobHandler) bool
